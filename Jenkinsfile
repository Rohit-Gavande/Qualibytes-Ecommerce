...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'rohitgavande45/qbshop-app'
        DOCKER_MIGRATION_IMAGE_NAME = 'rohitgavande45/qbshop-migration'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/Rohit-Gavande/Qualibytes-Ecommerce.git", "main")
                }
            }
        }
